...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_to_convert", type=str, default="/mnt/search/rank/demo/tianchi_ranker/code/v5/epoch/epoch1/epoch0_models-100", help="the checkpoint of trained model to convert") 
    parser.add_argument("--output_dir", type=str, default="/mnt/search/rank/demo/tianchi_ranker/code/v5/epoch/epoch1/wrapper1", help="the path of saved_model") 
